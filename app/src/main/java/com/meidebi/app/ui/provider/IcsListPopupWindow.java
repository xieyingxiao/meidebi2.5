...
class IcsListPopupWindow {
    ...
    private int buildDropDown() {
        ...
        if (mDropDownList == null) {
            ...
            mDropDownList.setDivider(XApplication.getInstance().getResources().getDrawable(R.color.list_black_divder));
            mDropDownList.setDividerHeight(2);
    ...
    private static class DropDownListView extends ListView {
        ...
        public DropDownListView(Context context, boolean hijackFocus) {
            super(context, null, /*com.android.internal.*/R.attr.dropDownListView);
