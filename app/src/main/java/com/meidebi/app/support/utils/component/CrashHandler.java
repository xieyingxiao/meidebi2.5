...
//		}.start();
	...
	// builder.setIcon(com.meidebi.app.R.drawable.ic_dialog_info);
	...
	// }
	// });
	// builder.setNegativeButton(com.meidebi.app.R.string.cancel,
	// new DialogInterface.OnClickListener() {
	// public void onClick(DialogInterface dialog, int which) {
	// dialog.dismiss();
	// // 退出
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				Toast.makeText(mContext,
						mContext.getString(R.string.err_gobal_app),
